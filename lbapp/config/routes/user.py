...
def make_user_routes(config):
    ...
    config.add_view(route_name='login', request_method='GET', renderer='templates/user/login.pt')
    ...
    config.add_view(route_name='register', request_method='GET', renderer='templates/user/register.pt')
    ...
    config.add_view(view=UserView, attr='profile', route_name='profile', request_method='GET', renderer='templates/user/profile.pt')
    config.add_view(view=UserView, attr='update_user', route_name='profile', request_method='PUT')
