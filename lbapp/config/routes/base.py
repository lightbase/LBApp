...
def make_base_routes(config):
    ...
    config.add_view(view=BaseView, attr='get_json_base', route_name='create_doc_json', request_method='GET', renderer='templates/routes/new2.pt')
    ...
    config.add_view(view=BaseView, attr='list_bases', route_name='list_bases', request_method='GET', renderer='templates/routes/list.pt')
    ...
    config.add_view(view=BaseView, attr='config_base', route_name='config_base', request_method='GET', renderer='templates/routes/config.pt')
    ...
    config.add_view(route_name='explore_base', request_method='GET', renderer='templates/routes/explore.pt')
