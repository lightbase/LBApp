...
O LBApp é a interface do banco de dados Lightbase para usuários finais. Essa interface permite gerenciar criar basa de dados, preencher dados, compartilhar bases e emitir relatórios. 
